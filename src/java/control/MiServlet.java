...
public class MiServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Hola Mindo Java Web desde Post</h1>");
            if(it==null){
            out.println("<h1>El usuario No existe o Clave incorrecta</h1>");
            }else{
            out.println("<h1>Bienvenido: "+it.getNombre()+" a tu sistema</h1>");
            }
            out.println("</body>");
            out.println("</html>");
        }
